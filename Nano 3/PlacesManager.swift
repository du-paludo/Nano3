...
class PlacesManager {
    ...
    static var places = [
        ...
        Place(
            name: "CAAD",
            images: ["caad1"],
            description: "CAAD (Centro Acadêmico Alexandre Direne) é o centro acadêmico do curso de Ciência da Computação da UFPR, localizado no Centro Politécnico.",
